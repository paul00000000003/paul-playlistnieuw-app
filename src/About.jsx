...
class About extends React.Component {
  render() {
    return (
      <div>
        <img
          src="https://www.mupload.nl/img/5x0w4q1jw54.jpg"
          alt="photo"
          width="300px"
        />
        ...
        <p>
          ...
          direct in de ICT beland. Ik heb in eerste
        </p>
        <p>
          instantie bij een internationale helpdesk gewerkt, maar dat bood
          onvoldoende uitdaging. Vanuit die helpdesk
        </p>
        <p>
        ...
        <p>
          ...
          (BankView, Magnum draaiende op een VMS platform)
        </p>
        <p>
